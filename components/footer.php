...
<footer id="footer">
            ...
            <div class="footer-column footer-right">
                ...
                <div class="social-media">
                    ...
                    <div class="social-icons">
                        ...
                        <a href="https://x.com/codehciu" aria-label="Twitter" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                                <path d="M453.2 112L523.8 112L369.6 288.2L551 528L409 528L297.7 382.6L170.5 528L99.8 528L264.7 339.5L90.8 112L236.4 112L336.9 244.9L453.2 112zM428.4 485.8L467.5 485.8L215.1 152L173.1 152L428.4 485.8z"/>
                            </svg>
                        </a>
                        <a href="https://www.facebook.com/codehciu" aria-label="Facebook" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                ...
                <div class="contact-info">
                    ...
                    <p class="contact-item">
                        ...
                        <a href="tel:+584249024700"><span>+58 424 9024700</span></a>
                    </p>
                    <p class="contact-item">
                        <i class="fas fa-envelope"></i>
                        <a href="mailto:contacto@codehciu.org"><span>contacto@codehciu.org</span></a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <p>&copy; <?php echo date('Y'); ?> Comisión para los Derechos Humanos y la Ciudadanía. Todos los derechos reservados.</p>
